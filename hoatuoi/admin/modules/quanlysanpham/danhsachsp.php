...
<div class="container container-SP">
    ...
    <div style="display:flex;margin:20px 0">
		...
		<label>Số lượng</label>
                <select name="idSL" id ="idSL" style="padding:5px 8px">
        ...
        <table class="table table-hover table-SP">
            ...
            <tbody>
                ...
                <tr>
					...
					<td class="text-center"><?php echo $dong['soluong'] ?></td>
...
<script>
    $("#searchSP-btn").click(function(){
        ...
        $.get("modules/quanlysanpham/ajax-danhsachsp.php",{tenSP:tenSP,idCL:idCL,idSL:idSL},function(data){
            $(".ajax-SP").html(data);
        });
    });
