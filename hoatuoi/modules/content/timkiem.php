...
<form style="width:100%;margin-top:15px">
    <div class="row">
        ...
        <div class="col-md-3">
            <div class="form-group">
                <label for="idgia" style="font-size:20px">Mức Giá</label>
...
<div class="search">
    ...
    ?>
        <div class="col-xs-12 col-sm-6 col-md-4">
            <div class="box" >
                <div class="box-img" >
                    <a href="index.php?act=chitietsanpham&item=<?php echo $rows['idSP'] ?>"><img src="admin/uploads/<?php echo $rows['hinhanhSP'] ?>" alt="" class="img-products" style="width:240px;height:240px"></a>
                </div>
                <div class="box-content">
                    <div style="width:250px;height:40px;background:#95819d;line-height:40px;text-align:center">
            ...
            <nav aria-label="Page navigation example">
                <ul class="pagination">
                    <?php
                        ...
                        {
                            if($i==$current_page)
                                echo '<li  class="page-item"><a style="background-color:yellow" class="page-link" href="index.php?searchtext='.$search_txt.'&id='.$id.'&idgia='.$idgia.'&act=timkiem&page='.($current_page).'">'.$i.'</a></li>';
                            else
