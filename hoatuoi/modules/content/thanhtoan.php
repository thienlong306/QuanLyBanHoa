...
function myFunction() {
  ...
  var text = document.getElementById("thanhtoantructuyen");
...
<div style="width:100%">
    ...
    <div style="color:#191919;border:1px solid rgba(0,0,0,.1);padding:0 15px 0 15px">
        ...
        <form class="form-horizontal" action="modules/content/xulyform/payment.php" method="post" name="thanhtoan">
            <fieldset>
				...
				<div class="form-group">
					 <label class="col-md-4 control-label" for="">Thanh toán thực tuyến</label> 
					 
					 <div class="col-md-4">
                        <input type="checkbox" id="myCheck" onclick="myFunction()">
						<img style="width:30px" alt="" src="media\images\visa.svg">
						<img style="width:30px" alt="" src="media\images\jcb.svg">
						<img style="width:30px" alt="" src="media\images\mastercard.svg">
						<img style="width:30px" alt="" src="media\images\amex.svg">
                    </div>
				</div>
				<div id="thanhtoantructuyen" style="display:none">
					<div class="form-group">
						<label class="col-md-4 control-label" for="">Số thẻ</label>  
						<div class="col-md-4">
							<input value="1111 2222 3333 4444" type="text" name="sothe" class="form-control input-md" value="" />
							<span id="name"></span>
						</div>
					</div>
					<div class="form-group">
						<label class="col-md-4 control-label" for="">Ngày hết hạn</label>  
						<div class="col-md-4">
							<input value="mm/yy" type="text" name="sothe" class="form-control input-md" value="" />
							<span id="name"></span>
						</div>
					</div>
					<div class="form-group">
						<label class="col-md-4 control-label" for="">Mã bảo mật</label>  
						<div class="col-md-4">
							<input type="text" name="sothe" class="form-control input-md" value="" />
							<span id="name"></span>
						</div>
					</div>
