<div style="width:100%">
    ...
    <div style="color:#000;border:1px solid rgba(0,0,0,.1);padding:0 15px 0 15px">
    <?php
    ...
    ?>
	<table style='width:100%;font-size:18px;margin:10px 0'>
					<tr height='36px'>
                        <td colspan='2' class='text-center' style='width:30%;font-size:20px;font-weight:bold'>
							  <a href="index.php?act=edit"><input type='button' name='editInfo' value='Chình sửa thông tin' name='register-btn' class='btn btn-primary' /></a>    
                        </td>
                    </tr>
	</table>
    </div>
